...
class GUIHomepage(SiPage):
    def __init__(self, *args, **kwargs):
        ...
        self.background_image.load("assets/images/bgc.png")
        ...
        self.subtitle.setText("使用 Hanime!，你可以轻松的下载你想要的所有里番剧集，并实现类 Emby 的刮削功能")
        ...
        self.option_card_project.setTitle("测试")
        ...
        self.option_card_project.setDescription(
            "测试测试测试")  # noqa: E501
        self.option_card_project.setURL("https://github.com/xuanxuan-0403/hanime-spider")
        ...
        self.option_card_example.setDescription("测试测试测试")  # noqa: E501
