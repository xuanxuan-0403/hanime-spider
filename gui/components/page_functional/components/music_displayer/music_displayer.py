...
class SiMusicDisplayer(SiWidget):
    def __init__(self, *args, **kwargs):
        ...
        self.quick_play_panel.resize(160, 190)

        # 信息面板
        self.info_panel = InfoPanel(self)
        self.info_panel.setFixedHeight(190)
        self.info_panel.resize(512 - 128 + 12 - 12, 190)
        self.info_panel.animationGroup().fromToken("resize").setFactor(2/6)
    ...
    def enterEvent(self, a0):
        super().enterEvent(a0)
        self.info_panel.resizeTo(512 - 128 + 12 - 12 - 32, 190)

    def leaveEvent(self, a0):
        super().leaveEvent(a0)
        self.info_panel.resizeTo(512 - 128 + 12 - 12, 190)
