...
class GUIDownloadPage(SiPage):
    def __init__(self, *args, **kwargs):
        ...
        with self.titled_widgets_group as group:
            ...
            self.demo_displayer_1.resize(width, height)
            self.demo_displayer_1.loadInfo("assets/images/pages/functional/music_covers/cover1.jpg", "Moon Without The Stars", "Unknown Artist", "Unknown Album")  # noqa: E501

            self.demo_displayer_2 = SiMusicDisplayer(self)
            self.demo_displayer_2.resize(width, height)
            self.demo_displayer_2.loadInfo("assets/images/pages/functional/music_covers/cover2.png", "Never Gonna Give You Up", "Rick Astley", "Whenever You Need Somebody")  # noqa: E501

            self.demo_displayer_3 = SiMusicDisplayer(self)
            self.demo_displayer_3.resize(width, height)
            self.demo_displayer_3.loadInfo("assets/images/pages/functional/music_covers/cover3.png", "Friend", "玉置浩二", "ワインレッドの心")  # noqa: E501

            self.demo_displayer_4 = SiMusicDisplayer(self)
            self.demo_displayer_4.resize(width, height)
            self.demo_displayer_4.loadInfo("assets/images/pages/functional/music_covers/cover4.png", "雨中的重逢", "Parion圆周率", "Reunion In The Rain")  # noqa: E501

            self.demo_displayer_5 = SiMusicDisplayer(self)
            self.demo_displayer_5.resize(width, height)
            self.demo_displayer_5.loadInfo("assets/images/pages/functional/music_covers/cover5.png", "Melting White", "塞壬唱片-MSR / Cubes Collective", "Melting White")  # noqa: E501

            self.demo_displayer_6 = SiMusicDisplayer(self)
            self.demo_displayer_6.resize(width, height)
            self.demo_displayer_6.loadInfo("assets/images/pages/functional/music_covers/cover6.png", "Axolotl", "C418", "Axolotl")  # noqa: E501
